...
var _jurySlider = require("./modules/jury-slider");
...
},{"./modules/form-validate/form":3,"./modules/jury-slider":9,"./modules/modals/init-modals":10,"./modules/reviews-slider":12,"./modules/video":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
var initJurySlider = exports.initJurySlider = function initJurySlider() {
  var sliderJury = document.querySelector('[data-swiper="jury"]');
  var buttonPrev = document.querySelector('[data-button="prev-jury"]');
  var buttonNext = document.querySelector('[data-button="next-jury"]');
  var mySwiper = new window.Swiper(sliderJury, {
    // Настройки слайдера
    loop: true,
    navigation: {
      nextEl: buttonNext,
...
var initReviewsSlider = exports.initReviewsSlider = function initReviewsSlider() {
  var sliderReviews = document.querySelector('[data-swiper="reviews"]');
  var buttonPrev = document.querySelector('[data-button="prev-reviews"]');
  var buttonNext = document.querySelector('[data-button="next-reviews"]');
  var mySwiperReviews = new window.Swiper(sliderReviews, {
    // Настройки слайдера
    loop: true,
    navigation: {
      nextEl: buttonNext,
